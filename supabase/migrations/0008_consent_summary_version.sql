-- Track the consent summary card template version presented in the wizard.
-- Additive-only migration; keeps existing auth/RLS model intact.

alter table consent_records
  add column if not exists consent_summary_version text;
